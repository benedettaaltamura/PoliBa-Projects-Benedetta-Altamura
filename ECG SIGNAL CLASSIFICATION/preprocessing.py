...
def preprocessing(train_pd, test_df, spark=None):
    ...
    # Divisione Dataframes Pandas in features e labels
    ...
    complete_pipeline = Pipeline(stages=[assembler, scaler, pca])
    complete_pipeline_model = complete_pipeline.fit(test_df)
    complete_pipeline_model.write().overwrite().save(
        '/home/serena/Documenti/Progetto BigDataAnalytics/pythonProject_ECG/pipeline_model')
